    				  ...
    				  <!--判断记号是否为偶数 -->
   					  <s:else>
      				 	<tr style="line-height:30px; border-bottom:1px solid #dcdcdc;background-color:#ffffff">
											...
											<td style="padding-left: 10px" title="<s:property value='#listAnnouncements.announTitle' />">
												&nbsp;
												<s:if
                        ...
                        <s:a href="ViewAnnouncement?announId=%{#listAnnouncements.announId}" ><img src="images/mid5.jpg" width="77" height="19" /></s:a>
