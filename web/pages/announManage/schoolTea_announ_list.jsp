...
<div id="container">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
	   ...
	   <form action="" name="queryForm" method="post">  
		...
		<li>
		<p>发布者:
			<s:textfield name="publisherName" id="publisherName" style="width:85px;height:14px"/>
		</p>
		</li>
		
		<li>		
		<p>公告类型:
		 <s:select list='#{"00":"所有","学生公告":"学生公告","教师公告":"教师公告","学院公告":"学院公告","教务处公告":"教务处公告"}'
		  name="announTypeName" id="announTypeName" ></s:select>
      ...
      <li>
       <s:hidden id="totalPages" name="totalPage" value="%{totalPage}"></s:hidden>
		...
		<div class="xia_right" style="left:940px">
 ...
 <table width="97%" border="0" cellspacing="0" cellpadding="0" style=" border-bottom:1px solid #dcdcdc; border-left:1px solid #dcdcdc;border-right:1px solid #dcdcdc;" align="left" >
                      ...
                      <tr style="line-height:30px; border-bottom:1px solid #dcdcdc;">
                        <td style="padding-left:10px" bgcolor="#FFFFFF" width="28%" class="NoNewline">|公告名称</td>
