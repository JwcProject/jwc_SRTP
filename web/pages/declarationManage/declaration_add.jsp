                            ...
                            <div class="xia_gg">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.proName" id="text_xmsb"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" name="declaration.labLevel" value="01"
                                                   checked/><label for="male">校级实验室</label>
                                            <input type="radio" name="declaration.labLevel" value="02"/><label
                                                for="female">院级实验室</label>
                                            <input type="radio" name="declaration.labLevel" value="03"/><label
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.labName" id="text_xmrs"
                                                   class="easyui-validatebox"
                                                   data-options="required:true,validType:'length[1,50]'"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.memberAmount" id="text_xmrs"
                                                   class="easyui-validatebox"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.startOn" id="text_xmsj"
                                                   class="easyui-datebox" required="required" editable="false"/>
                                            <label for="name">至</label>
                                            <input type="text" name="declaration.endOn" id="text_xmsj"
                                                   class="easyui-datebox" required="required" editable="false"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="easyui-combobox" editable="false" required="required"
                            ...
                            <div class="xmjj_wbk">
                                ...
                                <h4>项目简介：</h4>
                                    <textarea name="declaration.proIntro" id="xm_wbj" class="project_info"
                                              style="width:770px;overflow-y:scroll"></textarea>
                          ...
                          style="border:1px solid #CCC;overflow-y:scroll;width:766px;height:90px;resize:none"></textarea>
                            ...
                            <div style="padding-top: 20px; padding-left: 35px; padding-bottom: 20px">
                                <a id="save" href="javascript:void(0);"
                                   onclick="javascript:addDeclaration(); return false;"><img
                                        src="<%=path%>/images/save1.png" alt="保存"/></a>
                                <a id="commit" href="javascript:void(0);"
                                   onclick="javascript:commitDeclaration(); return false;"><img
                                        src="<%=path%>/images/mima_anniu1.gif" alt="提交"/></a><label
                                    style="color: red;">*提交过后不能再修改！</label>
                            </div>
