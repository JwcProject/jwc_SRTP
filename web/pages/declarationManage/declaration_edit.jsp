                        ...
                        <div class="xmsb_shang">
                            ...
                            <dl class="artTabs" style="width:700px;margin-left: 30px">
                                <dt id="tabs"><a id="#tabContent1" class="select">研究内容</a> <a
                                        id="#tabContent2">立项意义</a> <a id="#tabContent3">研究方案</a> <a
                                        id="#tabContent4">创新点</a> <a id="#tabContent5">具备的研究条件</a> <a
                                        id="#tabContent6">进度安排</a> <a id="#tabContent7">预期研究目标</a><a
                                        id="#tabContent8">预期提交成果</a></dt>
