    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td width="88%" valign="top" style="padding-top:10px; padding-left:5px;" style="border:1px solid #dcdcdc"
                bordercolor="#f4f3f1" style="display:block;overFlow:auto">
                <div class="midbox" style=" overflow:scroll">
                    <div class="midbox_gg">
                        <div class="xmsb">项目申报表</div>
                    </div>
                    <form id="declarationForm" name="declarationForm" action="UpdateDeclaration" method="post"
                        ...
                        <div class="xmsb_shang">
                            ...
                            <div class="xia_gg">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.proName"
                                                   value="<s:property value="declaration.proName" />" id="text_xmsb"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="radio" name="declaration.labLevel" value="01"
                                                   <s:if test="declaration.labLevel=='01'">checked</s:if>/><label
                                                for="male">校级实验室</label>
                                            <input type="radio" name="declaration.labLevel" value="02"
                                                   <s:if test="declaration.labLevel=='02'">checked</s:if>/><label
                                                for="female">院级实验室</label>
                                            <input type="radio" name="declaration.labLevel" value="03"
                                                   <s:if test="declaration.labLevel=='03'">checked</s:if>/><label
                                                for="female">其他实验室</label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.labName"
                                                   value="<s:property value="declaration.labName" />" id="text_xmrs"
                                                   class="easyui-validatebox"
                                                   data-options="required:true,validType:'length[1,50]'"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.memberAmount"
                                                   value="<s:property value="declaration.memberAmount" />"
                                                   id="text_xmrs" class="easyui-validatebox"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.startOn"
                                                   value="<s:date  name="declaration.startOn" format="yyyy-MM-dd"/>"
                                                   id="text_xmsj" class="easyui-datebox" required="required"
                                                   editable="false"/>
                                            <label for="name">至</label>
                                            <input type="text" name="declaration.endOn"
                                                   value="<s:date  name="declaration.endOn" format="yyyy-MM-dd"/>"
                                                   id="text_xmsj" class="easyui-datebox" required="required"
                                                   editable="false"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="declaration.proFund" id="text_xmrs"
                                                   value="<s:property value="declaration.proFund" />"
                                                   class="easyui-validatebox"
                                                   data-options="required:true,validType:'number'"/>&nbsp;&nbsp;元
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="easyui-combobox" editable="false"
                                                   value="${declaration.proType}" required="required"
                                                   name="declaration.proType" id="declaration.proType"
                                ...
                                <div class="sblb_biaoge">
                                    ...
                                    <table id="datagrid">
                                        <s:if test="%{declaration.TStudentByLeaderCode != null}">
                                            <tr>
                                                <td><s:property
                                                        value="declaration.TStudentByLeaderCode.studentId"/></td>
                                                <td><s:property
                                        ...
                                        <s:if test="%{declaration.TStudentByMember1Code != null}">
                                            <tr>
                                                <td><s:property
                                                        value="declaration.TStudentByMember1Code.studentId"/></td>
                                                <td><s:property
                                        ...
                                        <s:if test="%{declaration.TStudentByMember2Code != null}">
                                            <tr>
                                                <td><s:property
                                                        value="declaration.TStudentByMember2Code.studentId"/></td>
                                                <td><s:property
                            ...
                            <div class="xmjj_wbk">
                                ...
                                <h4>项目简介：</h4>
                                <textarea name="declaration.proIntro" id="xm_wbj" class="project_info"
                                          style="overflow-y:scroll;width:699px;height:90px;"><s:property
                                        value="declaration.proIntro"/></textarea>
                            ...
                            <div class="xia_gg">
                                ...
                                <div class="gg_fujian_sb">
                                    <div class="xia_gg_left_sb">
                                        ...
                                        <p>相关附件:
                                            <s:iterator value="attachments" id="attachment"><a style="color:blue"
                                    ...
                                    <div class="xia_gg_right"><a href="#"><img
                                            src="<%=path%>/images/fabugonggao_wjj.gif" alt="上传文件"/></a>(只支持doc|docx格式)
                                    </div>
                            ...
                            <dl class="artTabs" style="width:700px;margin-left: 30px">
                                <dt id="tabs"><a href="#tabContent1" class="select">研究内容</a> <a
                                        href="#tabContent2">立项意义</a> <a href="#tabContent3">研究方案</a> <a
                                        href="#tabContent4">创新点</a> <a href="#tabContent5">具备的研究条件</a> <a
                                        href="#tabContent6">进度安排</a> <a href="#tabContent7">预期研究目标</a><a
                                        href="#tabContent8">预期提交成果</a></dt>
                                <dd id="tabContent1" style="display:block"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.resContent" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.resContent"/></textarea>
               </span></dd>
                                <dd id="tabContent2" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.proAdv" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.proAdv"/></textarea>
                </span></dd>
                                <dd id="tabContent3" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.resProgram" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.resProgram"/></textarea>
                </span></dd>
                                <dd id="tabContent4" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.innoPoint" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.innoPoint"/></textarea>
                </span>
                                </dd>
                                <dd id="tabContent5" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.resCondition" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.resCondition"/></textarea>
                </span>
                                </dd>
                                <dd id="tabContent6" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.proPlan" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.proPlan"/></textarea>
                </span>
                                </dd>
                                <dd id="tabContent7" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.expTarget" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.expTarget"/></textarea>
                </span>
                                </dd>
                                <dd id="tabContent8" style="display:none"><span
                                        style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="declaration.expResult" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                        value="declaration.expResult"/></textarea>
                </span>
                                </dd>
                            </dl>
                            ...
                            <input type="hidden" id="declaration.declarId" name="declaration.declarId"
                    ...
                    <div id="userDlg" class="easyui-dialog"
                        ...
                        输入学生学号:<input type="text" id="studentId" class="easyui-validatebox"
                                      data-options="required:true,validType:'number'"/>
                    </div>
                    <div id="dlg-buttons">
                    ...
                    <div id="teacherDlg" class="easyui-dialog"
                        ...
                        <br/>
                        输入教师姓名:<input type="text" id="teacherName" class="easyui-validatebox"
