    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="88%" valign="top" style="padding-top:10px; padding-left:5px;" style="border:1px solid #dcdcdc"
                bordercolor="#f4f3f1" style="display:block;height: auto;">
                <div class="midbox" style="height: auto;">
                    ...
                    <div class="xmsb_shang" style="height:inherit;">
                            ...
                            <div class="sblb_biaoge" style="margin-left:35px">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr style="line-height:30px; border-bottom:1px solid #dcdcdc;">
                                        <td style="padding-left:10px" bgcolor="#FFFFFF" width="6%" class="NoNewline">
                                            |姓名
                                        </td>
                        ...
                        <div class="xmjj_wbk">
                            ...
                            <p><s:iterator value="attachments" id="attachment"><a style="color:blue"
                        ...
                        <div class="sblb_biaoge" style="margin-left:35px">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr style="line-height:30px; border-bottom:1px solid #dcdcdc;">
                                    <td style="padding-left:10px" bgcolor="#FFFFFF" width="6%" class="NoNewline">|姓名
                                    </td>
