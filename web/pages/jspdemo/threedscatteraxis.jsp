...
Date[] dataX = {new GregorianCalendar(2011, 8, 1).getTime(), new GregorianCalendar(
    2011, 8, 2).getTime(), new GregorianCalendar(2011, 8, 3).getTime(),
    new GregorianCalendar(2011, 8, 4).getTime(), new GregorianCalendar(2011, 8, 5
    ).getTime(), new GregorianCalendar(2011, 8, 6).getTime(), new GregorianCalendar(
    2011, 8, 7).getTime(), new GregorianCalendar(2011, 8, 8).getTime(),
    new GregorianCalendar(2011, 8, 9).getTime(), new GregorianCalendar(2011, 8, 10
...
// Add a legend box at (380, 40) with horizontal layout. Use 9 pts Arial Bold font.
