              ...
              <tr>
                <td height="35">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="33%" height="25">项目名称：<s:property value="declaration.proName"/></td>
                    ...
                    <tr>
                      <td width="33%" height="25">实验室名称：<s:property value="declaration.labName"/></td>
                      <td width="33%" height="25">项目组人数：<s:property value="declaration.memberAmount"/></td>
                    </tr>
                    <tr>
                      <td height="25">项目实施时间：
                        <s:date name="declaration.startOn" format="yyyy-MM-dd"/> 至 <s:date name="declaration.endOn"
                    ...
                    <tr>
                      <td height="25" colspan="3">
                        <dl class="artTabs">
                          <dt id="tabs"><a href="#tabContent1" class="select">项目简介</a> <a href="#tabContent2">创新点</a> <a
                                  href="#tabContent3">研究成果</a></dt>
                          <dd id="tabContent1" style="display:block"><s:property value="declaration.proIntro"/></dd>
                          <dd id="tabContent2"><s:property value="declaration.innoPoint"/></dd>
                          <dd id="tabContent3" style="display:none"><s:property value="declaration.expResult"/></dd>
                ...
                <td height="35">
                  <div>
                    <form id="opinionForm" action="AddComments" method="post">
                      <input type="hidden" name="declarId" value="<s:property value="declaration.declarId" />"/>
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                          <td height="30">网评意见：</td>
                        </tr>
                        <tr>
                          <td height="30"><textarea name="declComment.declArgument" cols="80" rows="6" id="textfield2"
                        ...
                        <tr>
                          <td height="30">综合评定：
                            <select name="declComment.compEval" id="select" class="cxselect">
                              <option value="02">-建议立项-</option>
                              <option value="01">-不建议立项-</option>
                            </select>
                            　评分
                            <input name="declComment.declScore" id="declComment.declScore" size="10" class="cxinput"
                                   type="text"
                        ...
                        <tr>
                          <td height="30"><a href="javascript:void(0);" onclick="saveComment();"><img
                                  src="images/tijiaowanping.png" height="22" width="86"></a>
                            <a href="javascript:void(0);" onclick="history.go(-1);"><img src="images//quxiao.png"
