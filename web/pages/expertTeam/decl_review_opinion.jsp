                        ...
                        <div class="xmsb_shang">
                                ...
                                <div class="sblb_biaoge">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr style="line-height:30px; border-bottom:1px solid #dcdcdc;">
                                            <td style="padding-left:10px" bgcolor="#FFFFFF" width="6%"
                                                class="NoNewline">|姓名
                                            </td>
                            ...
                            <dl class="artTabs" style="width:700px;margin-left: 37px">
                                <dt id="tabs"><a href="#tabContent1" class="select">项目简介</a> <a
                                        href="#tabContent2">创新点</a> <a href="#tabContent3">预期提交成果：</a></dt>
                            ...
                            <div class="yanjiu_nr">
                                ...
                                <p><s:iterator value="attachments" id="attachment"><a
                                        href="downLoadAttachment?attachementId=<s:property value="attaId" />"><s:property
                                        value="fileName"/></a>&nbsp;&nbsp;</s:iterator></p>
                                ...
                                <form id="reviewOpinion" name="reviewOpinion" action="" method="post">
                                    <div style="text-align:left;">
                                        ...
                                        <textarea rows="8" cols="50" name="opinion" class="project_info"
                                                  style="overflow-y:scroll;width:699px;height:90px;resize:none"><s:property
                                                value="declaration.reviewOpinion"/></textarea>
                                    </div>
