								...
								<table width="96%" border="0" cellspacing="0" cellpadding="0"
									...
									<s:iterator value="endProjectComments" id="endProjectComments" status="stuts">
										...
										<td style="padding-left:10px" class="NoNewline"><s:property
														value="#endProjectComments.TEndProjectExport.TEndProject.endprojectNumber"/></td>
										<td title="<s:property value='#endProjectComments.TEndProjectExport.TEndProject.endprojectName' />">
											<s:if test="%{#endProjectComments.TEndProjectExport.TEndProject.endprojectName.length()>20}">
												<s:property
																value="%{#endProjectComments.TEndProjectExport.TEndProject.endprojectName.substring(0,20)+'...'}"
										...
										<td><s:property
														value="#endProjectComments.TEndProjectExport.TEndProject.TProject.TStudentByProjectLeader.studentName"/></td>
										<td><s:property
														value="#endProjectComments.TEndProjectExport.TEndProject.TProject.TStudentByProjectLeader.studentNumber"/></td>
										<td><s:property
														value="#endProjectComments.TEndProjectExport.TEndProject.TProject.TStudentByProjectLeader.TProfession.professionName"/></td>
										<td>
