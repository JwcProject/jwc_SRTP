                    ...
                    <div class="midbox">
                                ...
                                <table width="90%" height="200px" align="left" border="0"
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            <p>
                                                简介：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <input type="text" name="teacherIntro" id="jj" datatype="*"
                                                       sucmsg="验证通过" nullmsg="请输入简介" errormsg="请正确输入"/>
                        ...
                        <div class="xia_anniu_zj">
                            <ul>
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                       onclick="moveall(getElementsByName('preCreateExpert')[0].destList,getElementsByName('preCreateExpert')[0].srcList)"><img
                                            src="images/zhuanjia_anniu6.gif" width="103" height="25"
                                            alt="取消"/>
                                    </a>
                                </li>
