              ...
              <div class="xia_list">
                ...
                <table width="97%" border="0" cellspacing="0" cellpadding="0"
                  ...
                  <tr style="line-height:30px; border-bottom:1px solid #dcdcdc;">
                    <td style="padding-left:10px" bgcolor="#FFFFFF" width="14%" class="NoNewline"><input type="checkbox"
                                                                                                         name="ALL"
                                                                                                         id="ALL"
                                                                                                         onClick="check()"
                                                                                                         value="on "/><label
                  ...
                  <s:iterator value="endProjects" id="endProjects" status="stuts">
                    ...
                    <td><s:property
                            value="#endProjects.TProject.TStudentByProjectLeader.TProfession.professionName"/></td>
                    <td>
