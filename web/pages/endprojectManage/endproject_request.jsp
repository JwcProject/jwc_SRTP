            ...
            <form id="endprojectRequest" name="endprojectRequest" method="post" enctype="multipart/form-data">
              <div class="xmsb_shang">
                            ...
                            <tr>
                              ...
                              <td align="left">
                                ...
                                <s:hidden name="studentNumber"
                                          value="%{project.TStudentByProjectLeader.studentNumber}"></s:hidden>
                              </td>
                              <td align="left">
											<textarea rows="3" cols="40" style="overflow-y:scroll;resize:none"
                                name="endprojectJob.jobContent" class="easyui-validatebox"
                                data-options="required:true,validType:'length[1,250]'"></textarea>
                              </td>
                              <td align="left">
                                <textarea rows="3" cols="25" style="overflow-y:scroll;resize:none"
                                          name="endprojectJob.finished" class="easyui-validatebox"
                                          data-options="required:true,validType:'length[1,25]'"></textarea>
                              </td>
                            </tr>
                          </s:if>
                          <s:if test="%{project.TStudentByProjectUser1 != null}">
                            <tr>
                              ...
                              <td align="left" style="width:100px">
                                ...
                                <s:hidden name="studentNumber1"
                                          value="%{project.TStudentByProjectUser1.studentNumber}"></s:hidden>
                              </td>
                              <td align="left">
											<textarea rows="3" cols="40" style="overflow-y:scroll;resize:none"
                                name="endprojectJob1.jobContent" class="easyui-validatebox"
                                data-options="required:true,validType:'length[1,250]'"></textarea>
                              </td>
                              <td align="left">
                                <textarea rows="3" cols="25" style="overflow-y:scroll;resize:none"
                                          name="endprojectJob1.finished" class="easyui-validatebox"
                                          data-options="required:true,validType:'length[1,25]'"></textarea>
                              </td>
                            </tr>
                          </s:if>
                          <s:if test="%{project.TStudentByProjectUser2 != null}">
                            <tr>
                              ...
                              <td align="left" style="width:100px">
                                ...
                                <s:hidden name="studentNumber2"
                                          value="%{project.TStudentByProjectUser2.studentNumber}"></s:hidden>
                              </td>
                              <td align="left">
											<textarea rows="3" cols="40" style="overflow-y:scroll;resize:none"
                                name="endprojectJob2.jobContent" class="easyui-validatebox"
                                data-options="required:true,validType:'length[1,250]'"></textarea>
                              </td>
                              <td align="left">
                                <textarea rows="3" cols="25" style="overflow-y:scroll;resize:none"
                                          name="endprojectJob2.finished" class="easyui-validatebox"
                                          data-options="required:true,validType:'length[1,25]'"></textarea>
                              </td>
                            </tr>
                          </s:if>
                ...
                <div class="xmjj_wbk">
                  ...
                  <h4>项目成果简介：</h4>
                  <textarea name="endProject.endprojectIntroduction" id="xm_wbj" class="easyui-validatebox"
                            data-options="required:true,validType:'length[1,2000]'"
                            style="width:759px;height:150px;overflow-y:scroll;resize:none"></textarea>
                ...
                <div class="xia_gg">
                  ...
                  <div class="gg_fujian_sb">
                    ...
                    <div class="xia_gg_right"><a href="#"><img src="<%=path%>/images/fabugonggao_wjj.gif"
                                                               alt="上传文件"/></a>(只支持doc|docx格式)
                    </div>
                ...
                <dl class="artTabs" style="width:760px;margin-left: 30px">
                  <dt id="tabs"><a href="#tabContent1" class="select">研究的目的及意义</a> <a href="#tabContent2">主要内容</a> <a
                          href="#tabContent3">过程与方法</a> <a href="#tabContent4">创新点</a> <a
                          href="#tabContent5">存在的问题、建议</a> <a href="#tabContent6">自我评价分析与总结</a></dt>
                  <dd id="tabContent1" style="display:block"><span style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="endProject.endprojectSense" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:759px;height:150px;resize:none"></textarea>
               </span></dd>
                  <dd id="tabContent2" style="display:none"><span style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="endProject.endprojectContent" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:759px;height:150px;resize:none"></textarea>
                </span></dd>
                  <dd id="tabContent3" style="display:none"><span style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="endProject.endprojectMethod" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:759px;height:150px;resize:none"></textarea>
                </span></dd>
                  <dd id="tabContent4" style="display:none"><span style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="endProject.endprojectInnovate" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:759px;height:150px;resize:none"></textarea>
                </span>
                  </dd>
                  <dd id="tabContent5" style="display:none"><span style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="endProject.endprojectProblem" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:759px;height:150px;resize:none"></textarea>
                </span>
                  </dd>
                  <dd id="tabContent6" style="display:none"><span style=" padding-top:5px; padding-bottom:5px;">
                <textarea name="endProject.endprojectComment" id="textfield12"
                          style="border:1px solid #CCC;overflow-y:scroll;width:759px;height:150px;resize:none"></textarea>
                </span>
                  </dd>
                </dl>
