                            ...
                            <div class="ggzs_wz">
                                ...
                                <table align="left" style="margin-left:30px">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <s:textfield name="permission.permissionName" id="text_fabu"
                                                         cssStyle="width: 300px; font-size: 18px" datatype="*"
                                                         nullmsg="请输入权限名"/>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <s:radio name="permission.permissionState" cssStyle="font-size:18px"
                                                     list="#{'01':'已分配','02':'未激活'}"></s:radio>
                                        </td>
                                        <td>
                                            <span class="Validform_checktip" id="checkSpan"></span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <s:textfield name="permission.permissionUrl" id="text_fabu"
                                                         cssStyle="width: 300px; font-size: 18px" datatype="*"
                                                         nullmsg="请输入权限URL"/>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <s:select list='#{"0 ":"0","1 ":"1","2 ":"2"}'
                                                      name="permission.permissionName" id="select"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <input id="permissionFatherid" value="${permission.permissionFatherid}"
                                                   name="permission.permissionFatherid"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <s:textarea name="permission.permissionIntroduction"
