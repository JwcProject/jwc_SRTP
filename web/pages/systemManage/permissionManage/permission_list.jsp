                        ...
                        <div class="midbox">
                            ...
                            <div class="xia_left">
                                <table>
                                    <ul>
                                        ...
                                        <li>
                                            <p>权限名称:
                                                <s:textfield name="permission.permissionName" id="permissionName"
                                        ...
                                        <li>
                                            <p>权限层级:
                                                <s:textfield name="permission.permissionLevel" id="permissionLevel"
                                                             style="width:86px;height:14px"/>
                                            </p>
                                        </li>
                            ...
                            <div class="xia_right_sq" style="left:595px">
                                ...
                                <a href="javascript:document.queyForm.reset();"><img src="<%=path%>/images/reset.png"
                                                                                     alt="重置" "/></a>
                                <a href="PreAddPermission" target="_blank" style="margin-left: 170px"><img
                            ...
                            <div id="declaraList" class="xia_list">
                                <table width="88%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr style="line-height:30px; border-bottom:1px solid #dcdcdc;">
                                        <td style="padding-left:10px" bgcolor="#FFFFFF" width="9%" class="NoNewline">
                                            |权限名
                                        </td>
                                    ...
                                    <s:iterator value="listPermissions" id="listPermissions" status="stuts">
                                        ...
                                        <td style="padding-left:10px" class="NoNewline"><s:property
                                                value="#listPermissions.permissionName"/></td>
                                        <td>
                                            <s:if test="%{#listPermissions.permissionIntroduction.length()>10}">
                                                <s:property
                                                        value="%{#listPermissions.permissionIntroduction.substring(0,10)+'...'}"
                                        ...
                                        <td>
                                            <s:a href="ViewPermission?id=%{#listPermissions.permissionId}"
                                                 target="_blank"><img src="<%=path%>/images/shenbiaoliebiao_icon1.gif"
                                                                      alt="查看"/></s:a>
                                            <s:a href="PreUpdatePermission?id=%{#listPermissions.permissionId}"
                                                 target="_blank"><img src="<%=path%>/images/gonggaoweihu_icon3.gif"
                                                                      alt="编辑"/></s:a>
                                            <s:a href="DeletePermission?id=%{#listPermissions.permissionId}"><img
