                        ...
                        <div class="midbox">
                            ...
                            <div class="xia_right_sq" style="left:195px">
                                ...
                                <a href="javascript:document.queyForm.reset();"><img src="<%=path%>/images/reset.png"
                                                                                     alt="重置" "/></a>
                                <a href="PreAddRole" target="_blank" style="margin-left: 560px"><img
                                    ...
                                    <s:iterator value="listRoles" id="listRoles" status="stuts">
                                        ...
                                        <td>
                                            <s:if test="%{#listRoles.roleIntroduction.length()>10}">
                                                <s:property value="%{#listRoles.roleIntroduction.substring(0,10)+'...'}"
                                        ...
                                        <td>
                                            <s:a href="ViewRole?id=%{#listRoles.roleId}" target="_blank"><img
                                                    src="<%=path%>/images/shenbiaoliebiao_icon1.gif" alt="查看"/></s:a>
                                            <s:a href="PreUpdateRole?id=%{#listRoles.roleId}" target="_blank"><img
                                                    src="<%=path%>/images/gonggaoweihu_icon3.gif" alt="编辑"/></s:a>
                                            <s:a href="DeleteRole?id=%{#listRoles.roleId}"><img
                                                    src="<%=path%>/images/gonggaoweihu_icon4.gif" alt="删除"/></s:a>
                                            <s:a href="PreAssignPermission?id=%{#listRoles.roleId}" target="_blank"><img
                                                    src="<%=path%>/images/permission_icon.png" alt="权限添加"/></s:a>
                                        </td>
                                        </tr>
                                    </s:iterator>
