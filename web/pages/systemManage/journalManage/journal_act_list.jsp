                        ...
                        <div class="midbox">
                            ...
                            <div class="xia_left">
                                <table>
                                    <ul>
                                        ...
                                        <li>
                                            <p>操作描述:
                                                <s:textfield name="journalactIntroduction" id="journalactIntroduction"
                                        ...
                                        <li>
                                            <p>操作时间:
                                                <s:textfield cssClass="easyui-datebox" name="time" id="time"
                            ...
                            <div class="xia_right_sq" style="left:760px">
                                ...
                                <a href="javascript:document.queyForm.reset();"><img src="<%=path%>/images/reset.png"
                                                                                     alt="重置" "/></a>
                                <a href="PreAddRole" target="_blank" style="margin-left: 630px"><img
                                ...
                                <table width="88%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <s:iterator value="listJournalActs" id="listJournalActs" status="stuts">
                                        ...
                                        <td style="padding-left:10px" class="NoNewline"><s:property
                                                value="#listJournalActs.userId"/></td>
