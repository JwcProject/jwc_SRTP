						...
						<table cellpadding="0" cellspacing="0" class="info-table"
							...
							<tr>
								...
								<td align="left" width="15%">
									<s:textfield name="user.userId" disabled="true"></s:textfield>
								</td>
							</tr>
							<tr>
								<td align="center" width="10%">
							...
							<tr>
								...
								<td align="left" width="15%">
									<s:password name="user.userPassword" value="%{user.userPassword}" id="pwd1" />
								</td>
							</tr>
							<tr>
								<td align="center" width="10%">
								...
								<td align="left" width="15%">
									<s:password name="userPassword" value="%{user.userPassword}" id="pwd2" />
								</td>
							</tr>
							<tr>
								<td align="center">
