                                ...
                                <table>
                                    <tr style="margin-left: -19px">
                                        ...
                                        <td>
                                            <p>
                                                项目编号:
                                                <s:textfield name="projectNumber" id="projectNumber"
...
<script type="text/javascript" language="javascript">
    ...
    function changePage(pageclickednumber) {
        ...
        location = "FindUnitProject?" + $('#queyForm').serialize();
    }

    function query() {
        $("#pages")[0].value = 1;
        document.queyForm.action = "<%=basePath%>FindUnitProject";
