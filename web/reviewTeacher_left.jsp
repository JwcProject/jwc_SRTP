              ...
              <dl>
                <dt class="menu_head">
                  ...
                  <div class="menu_body">
                     ...
                     <dd><a href="<%=path%>/findStuTeaAnnoun">我的公告</a></dd>
                  </div>  
              </dl>
              <dl>
                <dt class="menu_head">
                  <div class="jt"><img src="<%=path%>/images/jt3.png" width="13" height="8" /></div>
                       <img src="<%=path%>/images/3_anniu7.png" width="215" height="47" /></dt>
                  <div class="menu_body">
                     <!--<dd><a href="<%=path%>/pages/declarationManage/declaration_add.jsp">申报项目</a></dd>-->
                     <dd><a href="<%=path%>/ListTeaPersonalDeclaration">我的申报</a></dd>
                     
                     <dd><a href="<%=path%>/PreMyReview">我的评审</a></dd>
                  </div>
              </dl>
              <dl>
                <dt class="menu_head">
                  ...
                  <div class="menu_body">
                      <dd><a href="<%=path%>/ListTeaPersonalProject">我的项目</a></dd>
                  </div>
              </dl>
              <dl>
                <dt class="menu_head">
                  ...
                  <div class="menu_body"><!--
                      <dd><a href="<%=path%>/PreEndProjectRequest">申请结题</a></dd>
                     --><dd><a href="<%=path%>/PreMyEndProReview">我的评审</a></dd>
                  </div>
              </dl><!--
              <dl>
                <dt class="menu_head">
