...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["bold","italic","underline","strikethrough","forecolor","fontfamily","fontsize","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","indent","removeformat","formatmatch","autotypeset","customstyle","paragraph","rowspacingbottom","rowspacingtop","lineheight","inserttable","deletetable","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","time","date","spechars","insertcode","source","undo","redo","insertunorderedlist","insertorderedlist","link","unlink","cleardoc","selectall","print","searchreplace","preview","help"]]
