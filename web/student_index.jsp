                        ...
                        <tr>
                            <td width="88%" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"
                                    ...
                                    <tr>
                                        <td width="50%" valign="top" style="padding-top:10px; padding-left:4px;">
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0"
                                                   class="bd h193 " bgcolor="#f4f3f1">
                                                <tr>
                                                    <td valign="top">
                                                        <table width="99%" border="0" height="40" cellspacing="0"
                                                               cellpadding="0" align="center" class="bottomline mb5">
                                                            <tr>
                                                                <td width="85%">
                                                                    <div class="gonggao">教务处公告</div>
                                                                </td>
                                                                <td width="15%" align="right" class="morelink"><a
                                                                        href="findIndexDeanAnnouncement">更多>></a></td>
                                                            </tr>
                                                        </table>
                                                                    ...
                                                                    <li>
                                                                        <a href="ViewAnnouncement?announId=<s:property value = '#announcements.announId' />"
                                                                           target="_blank">
                                                                            ...
                                                                            <s:else>
                                                                                <s:property
                                                                                        value="#announcements.announTitle"/>
                                                                            </s:else>
                                                                        </a></li>
                                                                </s:iterator>
                                                            </ul>
                                        ...
                                        <td width="50%" valign="top" style="padding-top:10px;padding-left:6px;">
                                            <table width="99%" border="0" cellspacing="0" cellpadding="0"
                                                   class="bd h193 " bgcolor="#f4f3f1">
                                                <tr>
                                                    <td valign="top">
                                                        <table width="99%" border="0" height="40" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td width="85%">
                                                                    <div class="gonggao">学院公告</div>
                                                                </td>
                                                                <td width="15%" align="right" class="morelink"><a
                                                                        href="findIndexUnitAnnouncement">更多>></a></td>
                                                            </tr>
                                                        </table>
                                                        <div class="gonggaolist">
                                                            <ul>
                                                                <s:iterator value="unitAnnounList"
                                                                            id="announcementList">
                                                                    <li>
                                                                        <a href="ViewAnnouncement?announId=<s:property value = '#announcementList.announId' />"
                                                                           target="_blank">
                                                                            <s:if test="%{#announcementList.announTitle.length()>50}">
                                                                                <s:property
                                                                                        value="%{#announcementList.announTitle.substring(0,50)+'...'}"
                                                                                        escape="#onlineList.frmTitle"/>
                                                                            </s:if>
                                                                            <s:else>
                                                                                <s:property
                                                                                        value="#announcementList.announTitle"/>
                                                                            </s:else>
                                                                        </a></li>
                                                                </s:iterator>
                                                            </ul>
                                ...
                                <!-- 优秀项目 -->
                                <table width="99%" border="0" cellspacing="0" cellpadding="0" height="31"
                                       align="center">
                                    <tr>
                                        <td style="border:1px solid #bbd9e9">
                                            <table width="100%" height="29" border="0" cellspacing="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="goodpro">优秀项目</div>
                                                    </td>
                                                    <td width="15%" align="right" class="morelink"><a href="#">更多>></a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <div class="tablelist mb10">
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#eef7ff"><a href="#"><img src="images/mid5.jpg" width="86"
                                                                                   height="22"/></a></td>
                                        </tr>
                                        <tr>
                                            <td>工程类</td>
                                ...
                                <div class="tablelist mb10">
                                    <table width="99%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#eef7ff"><a href="#"><img src="images/mid5.jpg" width="86"
                                                                                   height="22"/> <img
                                                    src="images/mid6.jpg" width="86" height="22"/></a></td>
                                        </tr>
                                        <tr>
                                            <td>工程类</td>
                                            <td>如何写代码</td>
                            ...
                            <td width="14%" valign="top" style="padding-top:10px;">
                                <div class="w220 r_kuang h624 fr">
                                    ...
                                    <div class="teamlist centerdiv">
                                        <ul>
                                            <s:iterator value="commonAnnouncement" id="commonAnnouncement">
                                                <li>
                                                    <a href="ViewAnnouncement?announId=<s:property value = '#commonAnnouncement.announId' />"
                                                       target="_blank">
                                                        <s:if test="%{#commonAnnouncement.announTitle.length()>30}">
                                                            <s:property
                                                                    value="%{#commonAnnouncement.announTitle.substring(0,30)+'...'}"
                                                                    escape="#onlineList.frmTitle"/>
                                                        </s:if>
                                                        <s:else>
                                    ...
                                    <div class="qmenulist centerdiv">
                                        <ul>
                                            <li><a href="<%=path%>/ListDeclaration"><img src="images/right1.jpg"
                                                                                         width="70" height="60"/>
                                            ...
                                            <li><a href="#"><img src="images/right4.jpg" width="70" height="60"
