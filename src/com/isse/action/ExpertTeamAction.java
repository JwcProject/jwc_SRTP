...
/**
 * @Create Date：2013-7-29下午05:33:03
 * @Update Date：
 * @Author：lzh TODO
 */
public class ExpertTeamAction extends BaseAction {
	...
	/**
	 * 
	 * TODO 列出学院所有结题的专家团队 02为结题的专家团队 authoy lzh
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	public void endProScoreTypeIn() {
		try {
			...
			for (String project : checkProjects) {
				...
				// 学院录入成绩时间
				Date date = new Date();
				endProject.setUnitTypeinTime(date);
				endProject.setSchoolTypeinTime(date);
...
//			endProjectExports = this.endProjectExportService.findMyReviewEndPros(teacherCode, jieqi.getJqId(), pageBean);
	...
	/**
	 * 生成结果审核页面 TODO 获取学院评审通过的申报 authoy lzh
	 * 
	 * @return
	 */
	...
	/**
	 * 
	 * TODO 列出学院的历史专家库教师（申报类型的） authoy lzh
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * 
	 * TODO 从历史专家库添加至本期专家库 authoy lzh
	 * 
	 * @return
	 * @throws Exception
	 */
	...
	/**
	 * 
	 * TODO 根据专家库ID查看专家库的专家教师 authoy lzh
	 * 
	 * @return
	 * @throws Exception
	 */
