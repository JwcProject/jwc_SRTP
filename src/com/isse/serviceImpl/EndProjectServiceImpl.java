...
import com.isse.dao.TEndProjectDAO;
import com.isse.dao.TEndProjectExportDAO;
import com.isse.dao.TEndprojectJobDAO;
...
/**
 * @Create Date：2013-8-31上午12:39:56
 * @Update Date：
 * @Author：lzh
 * TODO
 */
public class EndProjectServiceImpl implements EndProjectService{
	...
	private void copyProperties(List<EndProject> endProjects,List<TEndProject> list){
		for (TEndProject tEndProject : list) {
			...
			endProject.setProfessionName(tEndProject.getTProject().getTStudentByProjectLeader().getTProfession().getProfessionName());
