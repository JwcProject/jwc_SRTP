 ...
 * TAnnouncement entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.isse.model.TAnnouncement
 * @author MyEclipse Persistence Tools
 */

public class TAnnouncementDAO extends HibernateDaoSupport {
	...
	public void save(TAnnouncement transientInstance) {
		log.debug("saving TAnnouncement instance");
		try {
	...
	public void delete(TAnnouncement persistentInstance) {
		log.debug("deleting TAnnouncement instance");
		try {
	...
	public TAnnouncement findById(java.lang.String id) {
		log.debug("getting TAnnouncement instance with id: " + id);
		try {
			TAnnouncement instance = (TAnnouncement) getHibernateTemplate()
					.get("com.isse.model.TAnnouncement", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TAnnouncement instance) {
		log.debug("finding TAnnouncement instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TAnnouncement instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from TAnnouncement as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all TAnnouncement instances");
		try {
			String queryString = "from TAnnouncement";
	...
	public TAnnouncement merge(TAnnouncement detachedInstance) {
		log.debug("merging TAnnouncement instance");
		try {
			TAnnouncement result = (TAnnouncement) getHibernateTemplate()
	...
	public void attachDirty(TAnnouncement instance) {
		log.debug("attaching dirty TAnnouncement instance");
		try {
	...
	public void attachClean(TAnnouncement instance) {
		log.debug("attaching clean TAnnouncement instance");
		try {
