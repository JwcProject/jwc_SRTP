...
import com.isse.model.TAchievement;

/**
 * A data access object (DAO) providing persistence and search support for
 * TAchievement entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.isse.model.TAchievement
 * @author MyEclipse Persistence Tools
 */

public class TAchievementDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(TAchievementDAO.class);
	// property constants
	...
	public void save(TAchievement transientInstance) {
		log.debug("saving TAchievement instance");
		try {
	...
	public void delete(TAchievement persistentInstance) {
		log.debug("deleting TAchievement instance");
		try {
	...
	public TAchievement findById(java.lang.String id) {
		log.debug("getting TAchievement instance with id: " + id);
		try {
			TAchievement instance = (TAchievement) getHibernateTemplate().get(
					"com.isse.model.TAchievement", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findAll() {
		log.debug("finding all TAchievement instances");
		try {
			String queryString = "from TAchievement";
