 ...
 * TDeclaration entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see com.isse.model.TDeclaration
 * @author MyEclipse Persistence Tools
 */

public class TDeclarationDAO extends HibernateDaoSupport {
	...
	public void save(TDeclaration transientInstance) {
		log.debug("saving TDeclaration instance");
		try {
	...
	public void delete(TDeclaration persistentInstance) {
		log.debug("deleting TDeclaration instance");
		try {
	...
	public TDeclaration findById(java.lang.String id) {
		log.debug("getting TDeclaration instance with id: " + id);
		try {
			TDeclaration instance = (TDeclaration) getHibernateTemplate().get(
					"com.isse.model.TDeclaration", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(TDeclaration instance) {
		log.debug("finding TDeclaration instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TDeclaration instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from TDeclaration as model where model."
					+ propertyName + "= ?";
	...
	public boolean checkHadReqDecla(String stuNumber){
		...
		try {
			...
			Query query = this.getSession().createQuery(quesString);
	...
	public List findAll() {
		...
		try {
			String queryString = "from TDeclaration";
	...
	public TDeclaration merge(TDeclaration detachedInstance) {
		log.debug("merging TDeclaration instance");
		try {
			TDeclaration result = (TDeclaration) getHibernateTemplate().merge(
					detachedInstance);
	...
	public void attachDirty(TDeclaration instance) {
		log.debug("attaching dirty TDeclaration instance");
		try {
	...
	public void attachClean(TDeclaration instance) {
		log.debug("attaching clean TDeclaration instance");
		try {
	...
	public List findAll(final PageBean pageBean , String studentId) {
		...
		try {
			...
			/*Query query = this.getSession().createQuery(queryStr);*/
			Query query = this.getSession().createSQLQuery(queryStr).addEntity(TDeclaration.class);
